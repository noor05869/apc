    ...
    <div class="wrapper">
      ...
      <div class="footergrid">
        <div class="brand-symbol">
          <div class="ncl-symbol"><img src={logonc} loading="lazy" width="64" alt=""/></div>
        </div>
        <div class="footernav font-bold">
          <div class="bt font-bold">Capabilities</div>
          <a href="#" class="blt">Investment Banking</a>
          <a href="#" class="blt">Institutional Brokerage</a>
          <a href="#" class="blt">Retail Investing</a>
          <a href="#" class="blt">Equity Research</a>
        </div>
        <div class="footernav font-bold">
          <div class="bt">Company</div>
          <a href="#" class="blt">About Us</a>
          <a href="#" class="blt">Investor Relations</a>
          <a href="#" class="blt">Downloads Center</a>
          <a href="#" class="blt">Careers</a>
          <a href="#" class="blt">Useful Links</a>
        </div>
        <div class="footernav font-bold">
          <div class="bt">Resources</div>
          <a href="#" class="blt">FAQ&#x27;s</a>
          <a href="#" class="blt">Privacy Policy</a>
          <a href="#" class="blt">Terms &amp; Conditions</a>
          <a href="https://nextcapital.com.pk/uploads/files/CODE_OF_CONDUCT_1_.pdf" class="blt">Code of Conduct</a>
          <a href="https://nextcapital.com.pk/uploads/files/THE-WHISTLEBLOWER-POLICY-Revised.pdf" class="blt">WB Policy</a>
          <a href="#" class="blt">Media</a>
        </div>
      </div>
      <div class="divider">
        <div class="dividerline"></div>
      ...
      <div class="footernotes">
        <div>
          <p style={{color:"#6b7280 !important"}} className="font-bold rights">© 2022 Next Capital Limited. All Rights Reserved</p>
        </div>
        <div class="sociallinks">
          <a href="https://www.facebook.com/NextCapitalLimitedPk" class="socialblock w-inline-block">
            <div class="socialicon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 17.9895 4.3882 22.954 10.125 23.8542V15.4688H7.07812V12H10.125V9.35625C10.125 6.34875 11.9166 4.6875 14.6576 4.6875C15.9701 4.6875 17.3438 4.92188 17.3438 4.92188V7.875H15.8306C14.34 7.875 13.875 8.80008 13.875 9.75V12H17.2031L16.6711 15.4688H13.875V23.8542C19.6118 22.954 24 17.9895 24 12Z" fill="CurrentColor"></path>
              </svg></div>
          </a>
          <a href="https://twitter.com/NextCapitalLtd" class="socialblock w-inline-block">
            <div class="socialicon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://instagram.com/nextcapitallimited?utm_medium=copy_link" class="socialblock w-inline-block">
            <div class="socialicon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.linkedin.com/company/next-capital-limited-pakistan" class="socialblock w-inline-block">
            <div class="socialicon w-embed"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="disclaimerr">
        ...
        <div>
          <p class="p2grey">“In case your complaint has not been properly redressed by us, you may lodge your complaint with Securities and Exchange Commission of Pakistan (the “SECP”). However, please note that SECP will entertain only those complaints which were at first directly requested to be redressed by the Company and the company has failed to redress the same. Further, the complaints that are not relevant to SECP’s regulatory domain/competence shall not be entertained.”</p>
        </div>
        <div class="trec">
          <p class="bt grey small ntn font-bold">NTN Number: 3536119<br/></p>
        </div>
        <div class="footergist">
          <div>
            <a href="#" class="secp w-inline-block"><img src={secp} loading="lazy" width="72" alt=""/></a>
            <a href="https://www.psx.com.pk/" class="secp _2 w-inline-block"><img src={psx} loading="lazy" width="72" alt=""/></a>
            <a href="https://www.cdcpakistan.com/" class="secp _2 w-inline-block"><img src={cdc} loading="lazy" width="72" alt=""/></a>
            <a href="https://www.nccpl.com.pk/" class="secp _2 w-inline-block"><img src={nccp} loading="lazy" width="72" alt=""/></a>
          </div>
          <div class="ratings"><img src={credit} loading="lazy" alt=""/></div>
        </div>
      </div>
    </div>
  </div>
